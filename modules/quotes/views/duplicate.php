<?php
/**
 * Duplicate Quote View with Navigation Integration
 */
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo url('dashboard', 'index'); ?>"><?php echo __('dashboard'); ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo url('quotes', 'list'); ?>">Cotizaciones</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo url('quotes', 'view', ['id' => $originalQuoteId]); ?>"><?php echo sanitizeOutput($originalQuote['quote_number']); ?></a>
                        </li>
                        <li class="breadcrumb-item active"><?php echo __('duplicate_quote'); ?></li>
                    </ol>
                </nav>
            </div>
