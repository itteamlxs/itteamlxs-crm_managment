        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="h3 mb-0"><?php echo __('edit_quote'); ?></h1>
                ...
                <form id="quoteForm" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><?php echo __('quote_details'); ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                            ...
                            <div class="card mt-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0"><?php echo __('quote_items'); ?></h5>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><?php echo __('quote_summary'); ?></h5>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h6 class="card-title mb-0"><?php echo __('quote_info'); ?></h6>
                                </div>
                                <div class="card-body">
                                    <small class="text-muted">
                                        <strong><?php echo __('quote_number'); ?>:</strong> <?php echo sanitizeOutput($quote['quote_number']); ?><br>
                                        <strong><?php echo __('current_status'); ?>:</strong> <?php echo sanitizeOutput($quote['status']); ?><br>
