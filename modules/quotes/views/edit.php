...
<head>
    ...
    <title><?php echo __('edit_quote'); ?> - <?php echo APP_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1><i class="bi bi-pencil-square"></i> <?php echo __('edit_quote'); ?></h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?= dashboardUrl() ?>"><i class="bi bi-house"></i> <?php echo __('dashboard'); ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo url('quotes', 'list'); ?>"><?php echo __('quotes'); ?></a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="<?php echo url('quotes', 'view', ['id' => $quoteId]); ?>">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-file-text"></i> <?php echo __('quote_details'); ?>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                    ...
                    <div class="card mt-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-box-seam"></i> <?php echo __('quote_items'); ?>
                            </h5>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">
                                <i class="bi bi-calculator"></i> <?php echo __('quote_summary'); ?>
                            </h5>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg"></i> <?php echo __('update_quote'); ?>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <h6 class="card-title mb-0">
                                <i class="bi bi-info-circle"></i> <?php echo __('quote_info'); ?>
                            </h6>
                        </div>
                        <div class="card-body">
                            <small class="text-muted">
                                <strong><?php echo __('quote_number'); ?>:</strong> <?php echo sanitizeOutput($quote['quote_number']); ?><br>
                                <strong><?php echo __('current_status'); ?>:</strong> 
                                <span class="badge bg-secondary"><?php echo sanitizeOutput($quote['status']); ?></span><br>
                                <strong><?php echo __('created_by'); ?>:</strong> <?php echo sanitizeOutput($quote['created_by_name']); ?><br>
                                <strong><?php echo __('created_at'); ?>:</strong> <?php echo formatDate($quote['created_at']); ?>
                            </small>
                        </div>
                    </div>
                </div>
