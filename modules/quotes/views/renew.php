    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePriceComparison() {
                ...
                if (differenceEl) {
                    if (difference > 0) {
                        differenceEl.innerHTML = '<i class="bi bi-arrow-up text-danger"></i> +$' + Math.abs(difference).toFixed(2) + ' <?php echo __('more'); ?>';
                        differenceEl.className = 'text-danger';
                    } else if (difference < 0) {
                        differenceEl.innerHTML = '<i class="bi bi-arrow-down text-success"></i> -$' + Math.abs(difference).toFixed(2) + ' <?php echo __('less'); ?>';
                        differenceEl.className = 'text-success';
                    } else {
                        differenceEl.innerHTML = '<i class="bi bi-dash text-muted"></i> <?php echo __('no_changes'); ?>';
