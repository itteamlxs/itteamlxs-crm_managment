...
<body>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="alert alert-info">
                    ...
                    <?php echo __('renewing_quote'); ?> <strong><?php echo sanitizeOutput($originalQuote['quote_number']); ?></strong>
                ...
                <form id="quoteForm" method="post" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><?php echo __('renewal_quote_details'); ?></h5>
                                </div>
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <small class="text-muted"><?php echo __('same_client_recommended'); ?></small>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <div class="card mt-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h5 class="card-title mb-0"><?php echo __('renewed_quote_items'); ?></h5>
                                    <div>
                                        <button type="button" id="updatePricesBtn" class="btn btn-outline-info btn-sm me-2">
                                            <i class="bi bi-arrow-clockwise"></i> <?php echo __('update_current_prices'); ?>
                                        </button>
                                ...
                                <div class="card-body">
                                    <div class="alert alert-warning">
                                        ...
                                        <?php echo __('renewal_items_warning'); ?>
                                    </div>
                                                    ...
                                                    <div class="col-md-2 mb-3">
                                                        ...
                                                        if ($currentPrice != $originalPrice): ?>
                                                            <small class="text-warning">
                                                                <i class="bi bi-exclamation-triangle"></i> 
                                                                <?php echo __('current_price'); ?>: <?php echo formatCurrency($currentPrice); ?>
                                                            </small>
                                                        <?php endif; ?>
                                                    </div>
                                                    <div class="col-md-2 mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0"><?php echo __('renewal_quote_summary'); ?></h5>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="d-grid">
                                        <button type="submit" class="btn btn-success">
                                            <i class="bi bi-arrow-clockwise"></i> <?php echo __('create_renewal'); ?>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mt-3">
                                <div class="card-header">
                                    <h6 class="card-title mb-0"><?php echo __('original_quote_comparison'); ?></h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <small class="text-muted d-block"><?php echo __('original'); ?>:</small>
                                            <strong><?php echo formatCurrency($originalQuote['total_amount']); ?></strong>
                                        </div>
                                        <div class="col-6">
                                            <small class="text-muted d-block"><?php echo __('new'); ?>:</small>
                                            <strong class="text-primary" id="comparisonTotal">$0.00</strong>
                                        </div>
                                    </div>
                                    <hr class="my-2">
                                    <div class="text-center">
                                        <small id="priceDifference" class="text-muted"><?php echo __('calculating'); ?>...</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <small class="text-muted">
                                        ...
                                        <strong><?php echo __('original_dates'); ?>:</strong><br>
                                        &nbsp;&nbsp;<?php echo __('issued'); ?>: <?php echo formatDate($originalQuote['issue_date']); ?><br>
                                        &nbsp;&nbsp;<?php echo __('expired'); ?>: <?php echo formatDate($originalQuote['expiry_date']); ?><br>
                            ...
                            <div class="card mt-3">
                                <div class="card-body text-center">
                                    ...
                                    <p class="small mb-0 text-muted mt-2">
                                        <?php echo __('renewal_creates_new_quote_with_reference'); ?>
                                    </p>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        // Enhanced functionality for renewal quotes
        document.addEventListener('DOMContentLoaded', function() {
            const originalTotal = <?php echo $originalQuote['total_amount']; ?>;
            
            // Update price comparison
            function updatePriceComparison() {
                const currentTotal = parseFloat(document.getElementById('totalAmount').textContent.replace('$', '').replace(',', '')) || 0;
                const difference = currentTotal - originalTotal;
                const comparisonEl = document.getElementById('comparisonTotal');
                const differenceEl = document.getElementById('priceDifference');
                
                if (comparisonEl) {
                    comparisonEl.textContent = '$' + currentTotal.toFixed(2);
                }
                
                if (differenceEl) {
                    if (difference > 0) {
                        differenceEl.innerHTML = '<i class="bi bi-arrow-up text-danger"></i> +$' + Math.abs(difference).toFixed(2) + ' más';
                        differenceEl.className = 'text-danger';
                    } else if (difference < 0) {
                        differenceEl.innerHTML = '<i class="bi bi-arrow-down text-success"></i> -$' + Math.abs(difference).toFixed(2) + ' menos';
                        differenceEl.className = 'text-success';
                    } else {
                        differenceEl.innerHTML = '<i class="bi bi-dash text-muted"></i> Sin cambios';
                        differenceEl.className = 'text-muted';
                    }
                }
            }
            ...
            // Override the quote manager to include comparison updates
            const originalUpdateQuoteTotal = window.QuoteManager?.prototype?.updateQuoteTotal;
            if (originalUpdateQuoteTotal) {
                window.QuoteManager.prototype.updateQuoteTotal = function() {
                    originalUpdateQuoteTotal.call(this);
                    updatePriceComparison();
                };
            }
            
            // Initial comparison update
            setTimeout(updatePriceComparison, 500);
        });
    </script>
</body>
</html>